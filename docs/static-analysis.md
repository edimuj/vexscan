...
Static analysis is Vexscan's primary detection mechanism. It uses regex pattern matching to identify known malicious
patterns in code, configuration files, and documentation.
...
1. **File Discovery**: Vexscan walks the target directory and identifies scannable files
...
```
vexscan scan ./suspicious-plugin
